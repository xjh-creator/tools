...
const (
	workerBits uint8 = 6  // 每台机器(节点)的ID位数 10位最大可以有2^10=1024个节点
	numberBits uint8 = 16 // 表示每个集群下的每个节点，1毫秒内可生成的id序号的二进制位数 即每毫秒可生成 2^12-1=4096个唯一ID
	...
	epoch int64 = 1567875599000 // 这个是我在写epoch这个变量时的时间戳(毫秒)
